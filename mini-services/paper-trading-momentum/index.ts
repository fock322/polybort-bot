#!/usr/bin/env bun
/**
 * Paper Trading Mini-Service — MOMENTUM strategy
 * Standalone Bun HTTP server — independent of Next.js
 * Port: 3003
 *
 * Runs momentum trend-following strategy with trailing TP.
 * State is isolated from contrarian service (port 3002) via separate process.
 */
...
console.log(`═══════════════════════════════════════════════════════════════`);
console.log(`  Paper Trading Mini-Service — MOMENTUM strategy — Port ${PORT}`);
...
<title>Polymarket MM Bot — MOMENTUM</title>
<style>
...
<body>
<div class="container">
  <h1>🚀 Polymarket MM Bot — MOMENTUM <span class="strategy-badge">TREND-FOLLOWING</span></h1>
